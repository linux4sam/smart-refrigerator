...
**
** Summary: C++ class that handles QML code for fridge zones controls
**
****************************************************************************/

#include "fridgezonesscreen.h"
#include "ui_fridgezonesscreen.h"
 ...
 **/
FridgeZonesScreen::FridgeZonesScreen(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::FridgeZonesScreen)
{
    ui->setupUi(this);
    ...
    if (isSmallResolution) {
        ...
        qmlView->setSource(QUrl("qrc:/qml/smallFridgeZones/main.qml"));
    } else {
        qmlView->setSource(QUrl("qrc:/qml/FridgeZones/main.qml"));
    }

    ui->fridgeZonesLayout->addWidget(qmlView);
}
