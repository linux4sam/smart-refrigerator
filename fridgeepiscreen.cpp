...
**
** Summary: C++ class that handles QML code for Epicurious screen
**
****************************************************************************/


#include "fridgeepiscreen.h"
#include "ui_fridgeepiscreen.h"
 ...
 **/
FridgeEpiScreen::FridgeEpiScreen(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::FridgeEpiScreen)
{
    ui->setupUi(this);
    ...
    //Register MyQDeclarativeWebView class with QML, to provide userAgent functionality
    qmlRegisterType<MyQDeclarativeWebView>("MyQDeclarativeWebView", 1, 0, "MyQDeclarativeWebView");

    if (isSmallResolution) {
        this->setGeometry(0, 0, 480, 272);
        qmlView->setSource(QUrl::fromLocalFile("CustomWidgets/Fridge-Epi/qml/smallFridgeEpi/main.qml"));
    } else {
        qmlView->setSource(QUrl::fromLocalFile("CustomWidgets/Fridge-Epi/qml/FridgeEpi/main.qml"));
    }

    ui->epicuriousLayout->addWidget(qmlView);
}
