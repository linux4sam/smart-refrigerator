...
private slots:
    ...
    void onContentsButtonPressed();
    void onEpiButtonPressed();
    void onInternetButtonPressed();
    void onWhiteboardButtonPressed();
    void onZonesButtonPressed();
