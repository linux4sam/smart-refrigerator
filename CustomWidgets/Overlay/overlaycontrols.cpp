    ...
    ui(new Ui::OverlayControls)
{
    ...
    declView->setAttribute(Qt::WA_NoSystemBackground);
    declView->viewport()->setAttribute(Qt::WA_NoSystemBackground);
    ...
    if (isSmallResolution) {
        this->setMinimumSize(0, 272);
        this->setMaximumWidth(51);
        this->resize(51, 272);

        declView->setSource(QUrl("qrc:/qml/smallOverlay/Overlay.qml"));
    } else {

        this->setMinimumSize(0, 480);
 ...
 ** C++ code
 **/
void OverlayControls::onCalendarButtonPressed ()
{
    emit(calendarRequest());
}
 ...
 ** C++ code
 **/
void OverlayControls::onContentsButtonPressed ()
{
    emit(contentsRequest());
}
 ...
 ** C++ code
 **/
void OverlayControls::onEpiButtonPressed ()
{
    emit(epiRequest());
}
 ...
 ** C++ code
 **/
void OverlayControls::onInternetButtonPressed ()
{
    emit(internetRequest());
}

void OverlayControls::onWhiteboardButtonPressed ()
{
    emit(whiteboardRequest());
}

void OverlayControls::onZonesButtonPressed ()
{
    emit(zonesRequest());
}
...
void OverlayControls::onViewStatusChanged(QDeclarativeView::Status status)
{
    ...
    {
        connect ((QObject *)declView->rootObject(), SIGNAL(onCalendarButtonPressed()),
                 this, SLOT(onCalendarButtonPressed()));
        connect ((QObject *)declView->rootObject(), SIGNAL(onContentsButtonPressed()),
                 this, SLOT(onContentsButtonPressed()));
        connect ((QObject *)declView->rootObject(), SIGNAL(onEpiButtonPressed()),
                 this, SLOT(onEpiButtonPressed()));
        connect ((QObject *)declView->rootObject(), SIGNAL(onInternetButtonPressed()),
                 this, SLOT(onInternetButtonPressed()));
        connect ((QObject *)declView->rootObject(), SIGNAL(onWhiteboardButtonPressed()),
                 this, SLOT(onWhiteboardButtonPressed()));
        connect ((QObject *)declView->rootObject(), SIGNAL(onZonesButtonPressed()),
                 this, SLOT(onZonesButtonPressed()));
    }
}
