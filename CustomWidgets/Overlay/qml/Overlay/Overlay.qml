...
Rectangle {
    ...
    ListModel {
        ...
        ListElement {
            ...
            applicationImageOff: "../../resources/images/shade-calendar.png"
            applicationImageOn: "../../resources/images/shade-calendar-on.png"
        }
        ListElement {
            applicationName: "contents"
            applicationImageOff: "../../resources/images/shade-contents.png"
            applicationImageOn: "../../resources/images/shade-contents-on.png"
        }
        ListElement {
            applicationName: "epi"
            applicationImageOff: "../../resources/images/shade-epi.png"
            applicationImageOn: "../../resources/images/shade-epi-on.png"
        }
        ListElement {
        ...
        ListElement {
            ...
            applicationImageOn: "../../resources/images/shade-zones-on.png"
        }
    }
    ...
    states: [
        ...
        State {
            name: "OffScreen"
            PropertyChanges {target: overlay; x: -75 }
    ...
    transitions: [
        ...
        Transition {
            from: "OnScreen"; to: "OffScreen"
                NumberAnimation { properties: "x"; to: -75; duration: 500; easing.type: Easing.InOutQuad }
        }
    ]
}
