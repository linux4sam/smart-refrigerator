...
**
** Summary: Window shade element that slides in on out the screen. It allows quick access to different screens
**
****************************************************************************/
...
Rectangle {
    ...
    // Signals generated by buttons on the overlay
    signal onCalendarButtonPressed()
    signal onContentsButtonPressed()
    signal onEpiButtonPressed()
    signal onInternetButtonPressed()
    signal onWhiteboardButtonPressed()
    signal onZonesButtonPressed()
    ...
    // Model that defines buttons on the overlay
    ListModel {
        id: buttonsModel

        ListElement {
            applicationName: "calendar"
            applicationImageOff: "../../resources/smallimages/shade-calendar.png"
            applicationImageOn: "../../resources/smallimages/shade-calendar-on.png"
        }
        ListElement {
            applicationName: "contents"
            applicationImageOff: "../../resources/smallimages/shade-contents.png"
            applicationImageOn: "../../resources/smallimages/shade-contents-on.png"
        }
        ListElement {
            applicationName: "epi"
            applicationImageOff: "../../resources/smallimages/shade-epi.png"
            applicationImageOn: "../../resources/smallimages/shade-epi-on.png"
        }
        ListElement {
            applicationName: "internet"
            applicationImageOff: "../../resources/smallimages/shade-internet.png"
            applicationImageOn: "../../resources/smallimages/shade-internet-on.png"
        }
        ListElement {
            applicationName: "whiteboard"
            applicationImageOff: "../../resources/smallimages/shade-whiteboard.png"
            applicationImageOn: "../../resources/smallimages/shade-whiteboard-on.png"
        }
        ListElement {
            applicationName: "zones"
            applicationImageOff: "../../resources/smallimages/shade-zones.png"
            applicationImageOn: "../../resources/smallimages/shade-zones-on.png"
        }
    }

    // All buttons are positioned in a Grid view layout - column
    GridView {
        id: gridViewOverlay
        x: 1
        y: 0
        ...
        function resetOverlayButtonStates()
        {
            for(var i=0; i< contentItem.children.length; i++)
            {
                var item = contentItem.children[i];
                if (item.objectName === "overlayObject")
                {
                    item.on = false
                    item.state = "Off"
                }
    ...
    states: [
        ...
        State {
            name: "OffScreen"
            PropertyChanges {target: overlay; x: -46 }
    ...
    transitions: [
        ...
        Transition {
            from: "OnScreen"; to: "OffScreen"
                NumberAnimation { properties: "x"; to: -37; duration: 500; easing.type: Easing.InOutQuad }
        }
    ]
}
