...
**
** Summary: Dialog Box that lets users select expiration date for dropped food
**
**
****************************************************************************/
...
Rectangle {
    ...
    property string expFoodName: ""
    property string expExpDate: ""
    property string expQuantityUnit: ""
    property int expQuantityNum: 1
    property string expIcon: ""

    // Helper functions

    // When not needed, unload calendar using loader calendarLoader
    function unloadCalendar()
    {
        calendarLoader.source = ""
    }

    // Based on food, preset Units, quantity and default exp date
    function presetWindowData()
    {
        var today = new Date()
        ...
        {
        case "Chicken":
                expQuantityUnit = "Piece"
                today.setDate(today.getDate()+20)
                expExpDate = Qt.formatDateTime(today, "MMM dd, yyyy")
                return 0;
        case "Apples":
                expQuantityUnit = "Piece"
        ...
        case "Ketchup":
                ...
                return 0;
        case "Milk":
                expQuantityUnit = "Gallon"
                today.setDate(today.getDate()+30)
                expExpDate = Qt.formatDateTime(today, "MMM dd, yyyy")
                return 0;
        case "Sausage":
                expQuantityUnit = "Link"
                today.setDate(today.getDate()+20)
                expExpDate = Qt.formatDateTime(today, "MMM dd, yyyy")
                return 0;
        case "Sushi":
                expQuantityUnit = "Tray"
        ...
        case "T-Bone":
                ...
                return 0;
        case "Wine":
                expQuantityUnit = "Bottle"
                today.setDate(today.getDate()+1360)
                expExpDate = Qt.formatDateTime(today, "MMM dd, yyyy")
                return 0;
        case "Shrimp":
                expQuantityUnit = "Container"
    ...
    Rectangle {
        ...
        // Close button - hides the Dialog Box without any action
        Button {
            id: closeButton
            width: 35
            height: 25
            radius: 5
            anchors { bottom: parent.bottom; right: parent.right; bottomMargin: 5; rightMargin: 5}
            buttonImageFront: "qrc:///qml/smallFridgeContents/resources/buttons/cancel.png"
            onButtonClicked: {
                onScreenBox.state = "hidden"
            }
        }

        // Add Food button. Adds new food to the XML file on the file system, reloads it and hides the Dialog Box
        Button {
             id: addButton
             anchors { bottom: parent.bottom; right: closeButton.left; bottomMargin: 5; rightMargin: 10}
             width: 35
             height: 25
             buttonImageFront: "qrc:///qml/smallFridgeContents/resources/buttons/ok.png"

             onButtonClicked: {
                 cppXMLParser.addFoodItem(expFoodName,expExpDate,expIcon, expQuantityNum, expQuantityUnit);
                 foodsListModel.reload();
                 onScreenBox.state = "hidden"
             }
         }
        // Quantity controls
        Rectangle
        {
            ...
            height: 35
            anchors { top: parent.top; topMargin: 50; left: parent.left; leftMargin: 10}
            ...
            Button {
                ...
                buttonImageFront: "qrc:///qml/smallFridgeContents/resources/plus.png"

                onButtonClicked: {
                    expQuantityNum = expQuantityNum+1
                }
            }

            Text {
                id: quantityNumber
                anchors { top: parent.top; topMargin: 10; left: incQuantity.right; leftMargin: 5}
                font.pixelSize: 18
                font.bold: true
                horizontalAlignment: Text.AlignHCenter
                text: expQuantityNum
            ...
            Button {
                ...
                width:25
                height:25
                anchors { top: parent.top; topMargin: 5; left: quantityNumber.right; leftMargin: 5}
                buttonImageFront: "qrc:///qml/smallFridgeContents/resources/minus.png"
            ...
            Text {
                id: quantityUnit
                anchors { top: parent.top; topMargin: 10; left: decQuantity.right; leftMargin: 10}
                font.pixelSize: 16
                font.bold: true
                horizontalAlignment: Text.AlignHCenter
                text: expQuantityUnit
                color: "white"
            }
        }
        ...
        Rectangle
        {
            ...
            width:parent.width - 25
            height: 40
            anchors { top: quantRect.bottom; topMargin: 15; left: parent.left; leftMargin: 10}
            ...
            Text {
                id: dateText
                anchors { top: parent.top; topMargin: 10; left: parent.left; leftMargin: 15}
                font.pixelSize: 18
                font.bold: true
                horizontalAlignment: Text.AlignHCenter
                text: expExpDate
            ...
            // When clicked, loads a calendar Month View which allows users to select specific date
            Button {
                id: showCalendar
                width:25
                height:25
                color: "lightblue"
                radius: 5
                anchors { top: parent.top; topMargin: 5; left: dateText.right; leftMargin: 10}
                buttonImageFront: "qrc:///qml/smallFridgeContents/resources/icon-calendar-view.png"


                Loader { id: calendarLoader }

                onButtonClicked: {
                    calendarLoader.source = "MonthView.qml"
                }
    ...
    states:
        State {
            name: "visible"
            PropertyChanges { target: onScreenBox; opacity: 1 }
            PropertyChanges { target: mainWindow; disableRect: true }
        }

    // Transition to bring the Dialog Box on the display
    transitions:
        Transition {
