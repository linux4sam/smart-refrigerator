...
Rectangle {
    ...
    Rectangle {
        ...
        Button {
            ...
            buttonImageFront: "qrc:///qml/FridgeContents/resources/buttons/cancel.png"
            onButtonClicked: {
        ...
        Button {
             id: addButton
             anchors { bottom: parent.bottom; right: closeButton.left; bottomMargin: 10; rightMargin: 20}
             width: 70
             height: 50
             buttonImageFront: "qrc:///qml/FridgeContents/resources/buttons/ok.png"
        ...
        Rectangle
        {
            ...
            Button {
                ...
                buttonImageFront: "qrc:///qml/FridgeContents/resources/plus.png"
            ...
            Text {
                id: quantityNumber
                anchors { top: parent.top; topMargin: 20; left: incQuantity.right; leftMargin: 10}
                font.pixelSize: 30
                font.bold: true
                horizontalAlignment: Text.AlignHCenter
                text: expQuantityNum
            ...
            Button {
                ...
                width:50
                height:50
                anchors { top: parent.top; topMargin: 10; left: quantityNumber.right; leftMargin: 10}
                buttonImageFront: "qrc:///qml/FridgeContents/resources/minus.png"
            ...
            Text {
                id: quantityUnit
                anchors { top: parent.top; topMargin: 20; left: decQuantity.right; leftMargin: 20}
                font.pixelSize: 24
                font.bold: true
                horizontalAlignment: Text.AlignHCenter
        ...
        Rectangle
        {
            ...
            width:parent.width - 50
            height: 70
            anchors { top: quantRect.bottom; topMargin: 30; left: parent.left; leftMargin: 20}
            ...
            Button {
                ...
                color: "lightblue"
                radius: 10
                anchors { top: parent.top; topMargin: 10; left: dateText.right; leftMargin: 20}
                buttonImageFront: "qrc:///qml/FridgeContents/resources/icon-calendar-view.png"
