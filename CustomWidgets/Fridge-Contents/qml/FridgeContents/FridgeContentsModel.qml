...
**
** Summary: Model for list of foods in the fridge.
**          It gets created based on an XML file content. File name passed from a C++ class
**
****************************************************************************/
...
XmlListModel {
    ...
    query: "/feed/contents/food"
//    namespaceDeclarations: "declare default element namespace 'http://www.w3.org/2005/Atom';"


    XmlRole { name: "foodName"; query: "name/string()" }
    XmlRole { name: "foodQuantityNum"; query: "quantityNum/string()" }
    XmlRole { name: "foodQuantityUnit"; query: "quantityUnit/string()" }
    XmlRole { name: "foodIcon"; query: "icon/string()" }
    XmlRole { name: "expirationDate"; query: "expiration/string()" }
}
