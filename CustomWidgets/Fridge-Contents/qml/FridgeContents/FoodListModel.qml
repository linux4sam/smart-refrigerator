...
ListModel {
    id: foodModel
    ListElement { name: "Chicken";  icon: "qrc:///qml/FridgeContents/resources/fridge-contents/icon-chicken.png"; selected: false; }
    ListElement { name: "Apples"; icon: "qrc:///qml/FridgeContents/resources/fridge-contents/icon-apples.png"; selected: false; }
    ListElement { name: "Cheese"; icon: "qrc:///qml/FridgeContents/resources/fridge-contents/icon-cheese.png"; selected: false; }
    ListElement { name: "Eggs"; icon: "qrc:///qml/FridgeContents/resources/fridge-contents/icon-eggs.png"; selected: false; }
    ListElement { name: "Fish"; icon: "qrc:///qml/FridgeContents/resources/fridge-contents/icon-fish.png"; selected: false; }
    ListElement { name: "Green Beans"; icon: "qrc:///qml/FridgeContents/resources/fridge-contents/icon-greenbeans.png"; selected: false; }
    ListElement { name: "Green Peppers"; icon: "qrc:///qml/FridgeContents/resources/fridge-contents/icon-greenpeppers.png"; selected: false; }
    ListElement { name: "Ham"; icon: "qrc:///qml/FridgeContents/resources/fridge-contents/icon-ham.png"; selected: false; }
    ListElement { name: "Jam"; icon: "qrc:///qml/FridgeContents/resources/fridge-contents/icon-jam.png"; selected: false; }
    ListElement { name: "Ketchup"; icon: "qrc:///qml/FridgeContents/resources/fridge-contents/icon-ketchup.png"; selected: false; }
    ListElement { name: "Milk"; icon: "qrc:///qml/FridgeContents/resources/fridge-contents/icon-milk.png"; selected: false; }
    ListElement { name: "Sausage"; icon: "qrc:///qml/FridgeContents/resources/fridge-contents/icon-sausage.png"; selected: false; }
    ListElement { name: "Sushi"; icon: "qrc:///qml/FridgeContents/resources/fridge-contents/icon-sushi.png"; selected: false; }
    ListElement { name: "T-Bone"; icon: "qrc:///qml/FridgeContents/resources/fridge-contents/icon-tbone.png"; selected: false; }
    ListElement { name: "Wine"; icon: "qrc:///qml/FridgeContents/resources/fridge-contents/icon-wine.png"; selected: false; }
    ListElement { name: "Shrimp"; icon: "qrc:///qml/FridgeContents/resources/fridge-contents/icon-shrimp.png"; selected: false; }
