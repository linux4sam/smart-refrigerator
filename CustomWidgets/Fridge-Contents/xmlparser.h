...
**
** Summary: Class definition responsible for manipulating XML file - read/write
**
**
****************************************************************************/
...
class XMLParser : public QObject
{
    Q_OBJECT
public:
    explicit XMLParser(QString file, QObject *parent = 0);
    
signals:
    
public slots:
    void removeFoodItem(const QString &foodName, int index);
    void addFoodItem(const QString &foodName, const QString &expirationDate, const QString &icon, const QString &quantityNum, const QString &quantityUnit);
