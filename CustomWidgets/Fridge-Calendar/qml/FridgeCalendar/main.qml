...
**
** Summary: Main QML file for the Calendar. It initializes main Rectangles and main elements
**          which are implemented in their own QML files
**
****************************************************************************/
...
Rectangle
{
    ...
    property int hourHeight: 54
    property int halfHourHeight: 26
    property int dayHeight: hourHeight * 24
    property bool monthView: true
    property string selectedDate: "Today"

    // Function for the loader to load Keyboard dynamically when needed
    function loadKeyboard()
    {
        kbdLoader.source = "Keyboard.qml"
    }
    ...
    Row
    {
        ...
        Rectangle
        {
            ...
            //Switch between Month/Day view button
            Button{
                id: calViewButton
                x: 143
                y: 13
                ...
                buttonImageFront: "qrc:///resources/icon-list-view.png"
                buttonImageBack: "qrc:///resources/icon-calendar-view.png"
            ...
            Rectangle
            {
                ...
                Column
                {
                    ...
                    property variant weekArray: ["Sun","Mon","Tue","Wed","Thu","Fri","Sat"]
                    property variant monthArray: ["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"]
                    x: 24
                    y: -170
                    width: 147
                    height: 147
                   ...
                   // anchors.bottomMargin: 15
                    ...
                    Text
                    {
                        x: 5
                        font.pointSize: 85
                        text: parent.currentDate.getDate()
                        color: "#ffffff"
                    }
                    ...
                    Text
                    {
                        x: 5
                        font.pointSize: 15
                        text: parent.weekArray[parent.currentDate.getDay()] + ', ' + parent.monthArray[parent.currentDate.getMonth()] + ', ' + parent.currentDate.getFullYear()
                        color: "#ffffff"
                    }
        ...
        Rectangle
        {
            ...
            // Calendar view - switches between Month and Day view
            Flipable {
                id: calView
                ...
                // The Day/Month views are implemented on the same Flipable element which is rotated 180 deg when requested
                transform: Rotation {
                     id: monthRotation
                     origin.x: calView.width/2
                     origin.y: calView.height/2
                     axis.x: 0; axis.y: 1; axis.z: 0
                     angle: 0    // the default angle
                 }

                // No animation has been implemented for state changes to achieve instant flip.
                 states: State {
                     name: "Month"
                     PropertyChanges { target: monthRotation; angle: 180 }
                     when: !mainCalendarRect.monthView
    ...
    //dynamically load the Keyboard
    Loader { id: kbdLoader }

    //intercept return button and unload keaboard
    Connections {
        target: kbdLoader.item
    onSigEnterButtonPressed: { dayWidget.setTextForEvent(key);
                                    kbdLoader.source = "" }
    }
