...
Item {
    ...
    function applicationClicked() {
        ...
        if(applicationName === "FridgeZones")
            mainScreenRectangle.sigMainScreenFridgeZonesPressed()
        else if(applicationName === "FridgeWhiteboard")
            mainScreenRectangle.sigMainScreenFridgeWhiteboardPressed()
        else if(applicationName === "FridgeEpicurious")
            mainScreenRectangle.sigMainScreenEpicuriousPressed()
        else if(applicationName === "FridgeBrowser")
            mainScreenRectangle.sigMainScreenWebBrowserPressed()
        else if(applicationName === "FridgeCalendar")
            mainScreenRectangle.sigMainScreenCalendarPressed()
        else if(applicationName === "FridgeContent")
            mainScreenRectangle.sigMainScreenContentsPressed()
...
//        Behavior on scale { NumberAnimation { duration: 900; easing.type: Easing.InOutQuad} }
        ...
        Item {
            ...
            width: 148; height: 146; anchors.centerIn: parent

            Column {
                spacing: 5
                Rectangle {
                    id: appRect; width: 148; height: 146; color: "#00000000"; smooth: false
                    Image { id: thumb; source: applicationImage; x: 1; y: 1; width: 148; height: 146; smooth: false }
    //                Image { source: "images/gloss.png" }
        ...
        states: [
           State {
            ...
            State {
                name: "Pressed"
                PropertyChanges { target: app; scale: 0.7 }
            },
            State {
                name: "State1"
