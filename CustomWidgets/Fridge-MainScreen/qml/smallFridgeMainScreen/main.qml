...
**
** Summary: Main QML file of the MainScreen widget. Instantiates all QML elements
**
****************************************************************************/
...
Rectangle {
    ...
    // used to trigger a Busy loading indicator
    function setLoadingFlag(flag)
    {
        loading = flag
    }
    ...
    Image
    {
        id: initialScreenBackground
        anchors.fill: parent
        source: "../../smallResources/water.jpg"
    }

    // signals that can be sent by various buttons on the main screen
    signal sigMainScreenFridgeZonesPressed ()
    signal sigMainScreenFridgeWhiteboardPressed ()
    signal sigMainScreenEpicuriousPressed ()
    signal sigMainScreenFridgeContentPressed ()
    signal sigMainScreenWebBrowserPressed ()
    signal sigMainScreenCalendarPressed ()
    signal sigMainScreenContentsPressed ()


    // Element that implements the main screen page
    Page
    {
        id: mainScreen
    }
