...
**
** Summary: Element that implements busy indicator that counts down - used to launch a web Browser
**          when a food category is selected
**
****************************************************************************/
...
Item {
    ...
    Image {
        ...
        source: "pics/busy.png"; visible: countDownBusy.active
        NumberAnimation on rotation { running: countDownBusy.active; from: 0; to: 360; loops: Animation.Infinite; duration: 1000 }
    }
    Text {
        id: countDownText
        anchors { verticalCenter: parent.verticalCenter; horizontalCenter: parent.horizontalCenter }
        text: ""
        visible: countDownBusy.active
    }
}
