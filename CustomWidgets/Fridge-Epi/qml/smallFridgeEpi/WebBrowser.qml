...
Rectangle {
    ...
    property string urlString : "http://www.epicurious.com/"
    ...
    Busy {
        id: load;
        anchors.horizontalCenter: webBrowser.horizontalCenter
        anchors.verticalCenter: webBrowser.verticalCenter
        active: webView.progress == 1.0 ? "false" : "true"
    }
