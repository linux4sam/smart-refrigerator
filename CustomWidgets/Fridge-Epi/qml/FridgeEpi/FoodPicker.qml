...
Rectangle {
    ...
    Image {
        id: backgroundImage
        anchors {top:ttext.bottom; topMargin: 40; horizontalCenter: parent.horizontalCenter }
    ...
    CountDownBusy {
        id: countDown
        anchors {top:backgroundImage.bottom; topMargin: 10; horizontalCenter: parent.horizontalCenter }
