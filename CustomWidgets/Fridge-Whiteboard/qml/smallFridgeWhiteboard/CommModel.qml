...
**
** Summary: Model Definition for comm buttons
**
****************************************************************************/
...
Item {
    ...
    ListModel {
        ...
        ListElement {
            name: "Twitter"
            iconOn: "qrc:/smallresources/icons/icon-twitter-on.png"
            iconOff: "qrc:/smallresources/icons/icon-twitter.png"
        }

        ListElement {
            name: "Facebook"
            iconOn: "qrc:/smallresources/icons/icon-facebook-on.png"
            iconOff: "qrc:/smallresources/icons/icon-facebook.png"
        }
        ListElement {
            name: "SMS"
            iconOn: "qrc:/smallresources/icons/icon-sms-on.png"
            iconOff: "qrc:/smallresources/icons/icon-sms.png"
        }
        ListElement {
            name: "EMail"
            iconOn: "qrc:/smallresources/icons/icon-email-on.png"
            iconOff: "qrc:/smallresources/icons/icon-email.png"
        }
    }
}
