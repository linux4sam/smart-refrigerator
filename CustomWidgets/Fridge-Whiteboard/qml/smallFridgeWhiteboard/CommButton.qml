...
**
** Summary: Communications button dummy element - no actual functionality implemented in this version
**
****************************************************************************/
...
Item {
    ...
    MouseArea {
        ...
        anchors.fill: parent
        onClicked: {
            commPickerButton.focus = true
            commPickerButton.state = "pressed"
            onCommOn = true
            stateTimer.start()
            commPickerTimer.restart()
        }
    }
    ...
    Item {
        ...
        Image {
            source: onCommOn ? iconOn : iconOff
    ...
    Timer {
        ...
        repeat: false
        onTriggered: {
            commPickerButton.state = "released"
    ...
    states: [
        State { name: "focus" ;
                when: focus
                PropertyChanges { target: commPickerButton; scale:1.0}
        },
        State { name: "pressed" ;
                PropertyChanges { target: commPickerButton; scale:1.4}
        },
        State { name: "released" ;
                PropertyChanges { target: commPickerButton; scale:1.0}
                PropertyChanges { target: commPickerButton; onCommOn: false}
        }
    ]
