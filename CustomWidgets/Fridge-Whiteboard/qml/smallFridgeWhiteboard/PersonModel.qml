...
**
** Summary: Model that defines all personas for the person pick widget
**
****************************************************************************/
...
Item {
    property alias personModel: person
    ...
    ListModel {
        ...
        ListElement {
            name: "Mom"
            iconOn: "qrc:/smallresources/faces/face-woman.png"
            iconOff: ""
        ...
        ListElement {
            name: "Dad"
            iconOn: "qrc:/smallresources/faces/face-man.png"
            iconOff: ""
            currentColor: "orange"
            on: true
        }
        ListElement {
            name: "Girl"
            iconOn: "qrc:/smallresources/faces/face-girl.png"
            iconOff: ""
            currentColor: "red"
            on: true
        }
        ListElement {
            name: "Boy"
            iconOn: "qrc:/smallresources/faces/face-boy.png"
            iconOff: ""
