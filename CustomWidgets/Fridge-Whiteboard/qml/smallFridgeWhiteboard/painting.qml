...
**
** Summary: Main QML file of the whiteboard widget
**
****************************************************************************/
...
Rectangle {
    ...
    property string selectedColor: "seagreen"
    property bool onColor: false
    property bool onComm: false

    PersonModel {id: personModel}
    CommModel { id: commModel }
    ...
    // Focus Scope element for the color picker
    FocusScope {
        id: colorPicker

        anchors { bottom: personPicker.top; left: personPicker.left; bottomMargin: 40; leftMargin: 20 }
        ...
        Column {
            ...
            spacing: 6
            Repeater {
                model: ["purple", "red", "orange", "steelblue", "seagreen"]
        ...
        transitions: [
            Transition {
                NumberAnimation { properties: "scale"; duration: 1000; easing.type: Easing.OutBack }
            }
        ...
        Timer {
            ...
            interval: 6000;
            repeat: false
            onTriggered: onColor = false
        }
    }

    // Focus scope element for communication set of buttons
    FocusScope {
        id: commPicker

        anchors { bottom: commButton.top; left: commButton.left; margins: 10; bottomMargin: 10 }
        ...
        Timer {
            ...
            interval: 6000;
            repeat: false
            onTriggered: onComm = false
        }
    }

    // Laste FocusScope element that provides implementation of a person picker
    FocusScope {
        id: personPicker

        anchors { bottom: parent.bottom; right: parent.right; rightMargin: 10; margins: 10 }
    ...
    Item {
        ...
        anchors { bottom: personPicker.top
        left: personPicker.left; margins: 2; bottomMargin: -2; leftMargin: -10 }

        Image {
            id: imageColorButton
            source: onColor ? "qrc:/smallresources/icons/icon-colorpicker-on.png" : "qrc:/smallresources/icons/icon-colorpicker.png"
        ...
        MouseArea {
            ...
            onClicked: {
                onColor = true
                colorPicker.state = "ShowColors"
                colorPickerTimer.start()
            }
        }

        states: State {
                    name: "pressed"; when: mousecolor.pressed
                    PropertyChanges { target: colorButton; scale: 1.2 }
               }

        transitions: Transition {
            SequentialAnimation{
                NumberAnimation { property: "scale"; to: 1.0; duration: 10 }
                NumberAnimation { property: "scale"; to: 1.4; duration: 300 }
    ...
    Item {
        ...
        anchors { bottom: personPicker.top
        left: personPicker.left; margins: 44; bottomMargin: 8; leftMargin: 36 }

        Image {
            id: imageClearButton
            source: "qrc:/smallresources/icons/icon-eraser.png"
            anchors.centerIn: parent
        }
        ...
        states: State {
                    name: "pressed"; when: mouseclear.pressed
                    PropertyChanges { target: clearButton; scale: 1.2 }
               }
    ...
    Item {
        ...
        anchors { bottom: personPicker.top
        left: clearButton.right; margins: 2; bottomMargin: -8; leftMargin: 5 }

        Image {
            id: imageCommButton
            source: onComm ? "qrc:/smallresources/icons/icon-speak-on.png" : "qrc:/smallresources/icons/icon-speak.png"
            anchors.centerIn: parent
        }
        ...
        MouseArea {
            ...
            anchors.fill:parent
            onClicked: {
                commPicker.state = "ShowComms"
                commPickerTimer.start()
                onComm = true
            }

        }
        states: State {
                    name: "pressed"; when: mousecomm.pressed
                    PropertyChanges { target: commButton; scale: 1.2 }
               }
    ...
    transitions: Transition {
        SequentialAnimation{
            NumberAnimation { target: colorPickerButton; property: "scale"; to: 1.0; duration: 10 }
            NumberAnimation { target: colorPickerButton; property: "scale"; to: 1.4; duration: 300 }
            NumberAnimation { target: colorPickerButton; property: "scale"; to: 1.0; duration: 300 }
        }
    }
