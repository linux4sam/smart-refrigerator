...
Item {
    ...
    ListModel {
        ...
        ListElement {
            name: "Twitter"
            iconOn: "qrc:/resources/icons/icon-twitter-on.png"
            iconOff: "qrc:/resources/icons/icon-twitter.png"
        }

        ListElement {
            name: "Facebook"
            iconOn: "qrc:/resources/icons/icon-facebook-on.png"
            iconOff: "qrc:/resources/icons/icon-facebook.png"
        }
        ListElement {
            name: "SMS"
            iconOn: "qrc:/resources/icons/icon-sms-on.png"
            iconOff: "qrc:/resources/icons/icon-sms.png"
        }
        ListElement {
            name: "EMail"
            iconOn: "qrc:/resources/icons/icon-email-on.png"
            iconOff: "qrc:/resources/icons/icon-email.png"
        }
    }
}
