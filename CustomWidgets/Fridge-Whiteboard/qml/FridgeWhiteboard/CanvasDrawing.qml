...
**
** Summary: Drawing element - responsible for handling touch events and for drawing on canvas
**
****************************************************************************/
...
// Canvas element is implemented in a subproject and is provided as a shared library
Canvas {
    id:canvas
    color: "white"
    property int paintX
    ...
    property variant drawColor: "firebrick"
    property variant drawingContext: getContext("2d");
    ...
    function drawLineSegment() {
        ...
        drawingContext.moveTo(paintX, paintY);
        drawingContext.lineTo(mousearea.mouseX, mousearea.mouseY);
    ...
    function drawPoint() {
        ...
        drawingContext.fillRect(mousearea.mouseX, mousearea.mouseY, 2, 2);
    }
