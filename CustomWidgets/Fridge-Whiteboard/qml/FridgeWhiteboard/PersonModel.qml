...
Item {
    ...
    ListModel {
        ...
        ListElement {
            name: "Mom"
            iconOn: "qrc:/resources/faces/face-woman.png"
            iconOff: ""
        ...
        ListElement {
            name: "Dad"
            iconOn: "qrc:/resources/faces/face-man.png"
            iconOff: ""
            currentColor: "orange"
            on: true
        }
        ListElement {
            name: "Girl"
            iconOn: "qrc:/resources/faces/face-girl.png"
            iconOff: ""
            currentColor: "red"
            on: true
        }
        ListElement {
            name: "Boy"
            iconOn: "qrc:/resources/faces/face-boy.png"
            iconOff: ""
