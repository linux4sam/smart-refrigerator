...
Rectangle {
    ...
    FocusScope {
        ...
        anchors { bottom: personPicker.top; left: personPicker.left; bottomMargin: 50; leftMargin: 20 }
    ...
    FocusScope {
        ...
        anchors { bottom: parent.bottom; right: parent.right; rightMargin: 50; margins: 20 }
    ...
    Item {
        ...
        Image {
            id: imageColorButton
            source: onColor ? "qrc:/resources/icons/icon-colorpicker-on.png" : "qrc:/resources/icons/icon-colorpicker.png"
    ...
    Item {
        ...
        anchors { bottom: personPicker.top
        left: colorButton.right; margins: 2; bottomMargin: 8; leftMargin: 10 }

        Image {
            id: imageClearButton
            source: "qrc:/resources/icons/icon-eraser.png"
            anchors.centerIn: parent
        }
    ...
    Item {
        ...
        anchors { bottom: personPicker.top
        left: clearButton.right; margins: 2; bottomMargin: -15; leftMargin: 5 }

        Image {
            id: imageCommButton
            source: onComm ? "qrc:/resources/icons/icon-speak-on.png" : "qrc:/resources/icons/icon-speak.png"
            anchors.centerIn: parent
        }
    ...
    function calculateX(index,count) {
        var ELEMENT_WIDTH = 120
        var SPACING = 10
        var TOTAL_WIDTH = count * ELEMENT_WIDTH + SPACING
        var OFFSET = ( 600 - TOTAL_WIDTH ) / 2
