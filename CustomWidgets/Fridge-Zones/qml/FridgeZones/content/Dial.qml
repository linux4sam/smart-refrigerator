...
Item {
    id: tempDial
    property real value: (tempSlider.x * 100 / (sliderRegion.width - 34))
    ...
    Image { x:0; y:0; source: "../images/temp-dial/zones-button-dial.png" }
...
/*    Image {
    ...
    Image {
        ...
        Image {
            ...
            MouseArea {
                ...
                drag.minimumX: 2; drag.maximumX: sliderRegion.width - 32
    ...
    states: [
       State {
            name: "Show";
            PropertyChanges { target: tempDial; scale: 1 }
    ...
    {
        tempSlider.x = val * (sliderRegion.width - 34)/100
        if(tempSlider.x<2)
            tempSlider.x = 2
        if(tempSlider.x> (sliderRegion.width - 32))
            tempSlider.x = sliderRegion.width - 32
    }
}
