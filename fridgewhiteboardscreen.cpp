...
**
** Summary: C++ class that handles QML code for fridge whiteboard controls
**
****************************************************************************/


#include "fridgewhiteboardscreen.h"
#include "ui_fridgewhiteboardscreen.h"
 ...
 **/
FridgeWhiteboardScreen::FridgeWhiteboardScreen(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::FridgeWhiteboardScreen)
{
    ui->setupUi(this);
    ...
    if (isSmallResolution) {
        ...
        qmlView->setSource(QUrl::fromLocalFile("CustomWidgets/Fridge-Whiteboard/qml/smallFridgeWhiteboard/painting.qml"));
    } else {
        qmlView->setSource(QUrl::fromLocalFile("CustomWidgets/Fridge-Whiteboard/qml/FridgeWhiteboard/painting.qml"));
    }

    ui->fridgeWhiteboardLayout->addWidget(qmlView);
}
