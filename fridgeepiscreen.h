...
#ifndef FRIDGEEPISCREEN_H
#define FRIDGEEPISCREEN_H

#include <QWidget>
#include <QDeclarativeView>

namespace Ui {
class FridgeEpiScreen;
}

extern bool isSmallResolution;

class FridgeEpiScreen : public QWidget
{
    Q_OBJECT
    
public:
    explicit FridgeEpiScreen(QWidget *parent = 0);
    ~FridgeEpiScreen();
    QDeclarativeView *qmlView;
    
private:
    Ui::FridgeEpiScreen *ui;
};

#endif // FRIDGEEPISCREEN_H
