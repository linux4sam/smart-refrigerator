...
#ifndef FRIDGECONTENTS_H
#define FRIDGECONTENTS_H
...
class FridgeContents : public QWidget
{
    Q_OBJECT
    
public:
    explicit FridgeContents(QWidget *parent = 0);
    ~FridgeContents();
    QDeclarativeView* qmlView;
    XMLParser* xmlParser;
    
private:
    Ui::FridgeContents *ui;
};

#endif // FRIDGECONTENTS_H
