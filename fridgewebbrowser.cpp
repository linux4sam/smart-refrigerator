...
**
** Summary: C++ class that handles QML code for fridge web browser screen
**
****************************************************************************/


#include "fridgewebbrowser.h"
#include "ui_fridgewebbrowser.h"
 ...
 **/
FridgeWebBrowser::FridgeWebBrowser(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::FridgeWebBrowser)
{
    ui->setupUi(this);
...
//    qmlRegisterType<MyQDeclarativeWebView>("MyQDeclarativeWebView", 1, 0, "MyQDeclarativeWebView");
    ...
    if (isSmallResolution) {
        ...
        qmlView->setSource(QUrl("qrc:/qml/smallwebbrowser/webbrowser.qml"));
    } else {
        qmlView->setSource(QUrl("qrc:/qml/webbrowser/webbrowser.qml"));
    }

    ui->fridgeWebBrowserLayout->addWidget(qmlView);
}

/***
 ** Default destructor
 **/
FridgeWebBrowser::~FridgeWebBrowser()
{
    delete qmlView;
    delete ui;
}
...
/***
 ** Method to reload current web page
 **/
void FridgeWebBrowser::setInitialURL()
{
/*    QObject *object = qmlView->rootObject();

     QVariant returnedValue;
     QMetaObject::invokeMethod(object, "reloadPage",
