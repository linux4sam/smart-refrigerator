...
signals:
    ...
    void fridgeZonesRequested();
    void fridgeWhiteboardRequested();
    void fridgeEpiRequested();
    void fridgeBrowserRequested();
    void fridgeCalendarRequested();
    void fridgeContentsRequested();
    void setLoadingFlagQML(QVariant flag);

private slots:
    void onViewStatusChanged(QDeclarativeView::Status status);
    void onFridgeZonesPressed();
    void onFridgeWhiteboardPressed();
    void onFridgeEpiPressed();
    void onFridgeWebBrowserPressed();
    void onFridgeCalendarPressed();
    void onFridgeContentsPressed();
