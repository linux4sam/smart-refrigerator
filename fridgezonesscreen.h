...
#ifndef FRIDGEZONESSCREEN_H
#define FRIDGEZONESSCREEN_H
...
namespace Ui {
class FridgeZonesScreen;
}

class FridgeZonesScreen : public QWidget
{
    Q_OBJECT
    
public:
    explicit FridgeZonesScreen(QWidget *parent = 0);
    ~FridgeZonesScreen();
    QDeclarativeView* qmlView;

private:
    Ui::FridgeZonesScreen *ui;
};

#endif // FRIDGEZONESSCREEN_H
