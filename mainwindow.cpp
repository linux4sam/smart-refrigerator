    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->stackedWidget->setCurrentIndex(0);       //set the initial page to Home Screen page

    homeScreen = new HomeScreen(this);
    ui->pageHomeLayout->addWidget(homeScreen);

    //Delay the init of most screens till after I show the initial screen
    QTimer::singleShot(1000, this, SLOT(delayedInitProcess()));
    QTimer *timerHomeScreen = new QTimer(this);
    connect(timerHomeScreen, SIGNAL(timeout()), this, SLOT(switchToHomeScreen()));
    homeScreen->setLoadingFlag(true);
    timerHomeScreen->start(10000);
...
void MainWindow::switchToFridgeZonesScreen()
{
    ui->stackedWidget->slideInIdx(2);
}

void MainWindow::switchToFridgeWhiteboardScreen()
{
    ui->stackedWidget->slideInIdx(3);
}

void MainWindow::switchToFridgeEpiScreen()
{
    ui->stackedWidget->slideInIdx(4);
}

void MainWindow::switchToFridgeBrowserScreen()
{
    if(fridgeWebBrowserScreen)
        fridgeWebBrowserScreen->setInitialURL();
    ui->stackedWidget->slideInIdx(5);
}

void MainWindow::switchToFridgeCalendarScreen()
{
    ui->stackedWidget->slideInIdx(6);
}

void MainWindow::switchToFridgeContentsScreen()
{
...
//    qDebug("1----\n");
    fridgeZonesScreen = new FridgeZonesScreen(this);
    ui->pageFridgeZonesLayout->addWidget(fridgeZonesScreen);

//    qDebug("2----\n");

    fridgeWhiteboardScreen = new FridgeWhiteboardScreen(this);
    ui->pageFridgeWhiteboardLayout->addWidget(fridgeWhiteboardScreen);

//    qDebug("3----\n");

    fridgeEpiScreen = new FridgeEpiScreen(this);
    ui->pageFridgeEpiLayout->addWidget(fridgeEpiScreen);

//    qDebug("4----\n");

    fridgeWebBrowserScreen = new FridgeWebBrowser(this);
    ui->pageWebBrowserLayout->addWidget(fridgeWebBrowserScreen);

//    qDebug("5----\n");

    fridgeCalendarScreen = new FridgeCalendar(this);
    ui->pageCalendarLayout->addWidget(fridgeCalendarScreen);

//    qDebug("6----\n");

    fridgeContentsScreen = new FridgeContents(this);
    ui->pageContentsLayout->addWidget(fridgeContentsScreen);
...
//    qDebug("7----\n");
    ...
    QObject::connect(homeScreen, SIGNAL(fridgeZonesRequested()), this, SLOT(switchToFridgeZonesScreen()));
    QObject::connect(homeScreen, SIGNAL(fridgeWhiteboardRequested()), this, SLOT(switchToFridgeWhiteboardScreen()));
    QObject::connect(homeScreen, SIGNAL(fridgeEpiRequested()), this, SLOT(switchToFridgeEpiScreen()));
    QObject::connect(homeScreen, SIGNAL(fridgeBrowserRequested()), this, SLOT(switchToFridgeBrowserScreen()));
    QObject::connect(homeScreen, SIGNAL(fridgeCalendarRequested()), this, SLOT(switchToFridgeCalendarScreen()));
    QObject::connect(homeScreen, SIGNAL(fridgeContentsRequested()), this, SLOT(switchToFridgeContentsScreen()));

//    qDebug("8----\n");

    overlayControls = new OverlayControls(this);
//    overlayControls->showFullScreen();
    overlayControls->setVisible(false);

//    qDebug("9----\n");

    QObject::connect(overlayControls, SIGNAL(whiteboardRequest()), this, SLOT(switchToFridgeWhiteboardScreen()));
    QObject::connect(overlayControls, SIGNAL(zonesRequest()), this, SLOT(switchToFridgeZonesScreen()));
    QObject::connect(overlayControls, SIGNAL(epiRequest()), this, SLOT(switchToFridgeEpiScreen()));
    QObject::connect(overlayControls, SIGNAL(internetRequest()), this, SLOT(switchToFridgeBrowserScreen()));
    QObject::connect(overlayControls, SIGNAL(calendarRequest()), this, SLOT(switchToFridgeCalendarScreen()));
    QObject::connect(overlayControls, SIGNAL(contentsRequest()), this, SLOT(switchToFridgeContentsScreen()));

    homeScreen->setLoadingFlag(false);
