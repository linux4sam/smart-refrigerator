...
#ifndef FRIDGEWHITEBOARDSCREEN_H
#define FRIDGEWHITEBOARDSCREEN_H

#include <QWidget>
#include <QtDeclarative>

namespace Ui {
class FridgeWhiteboardScreen;
}

extern bool isSmallResolution;

class FridgeWhiteboardScreen : public QWidget
{
    Q_OBJECT
    
public:
    explicit FridgeWhiteboardScreen(QWidget *parent = 0);
    ~FridgeWhiteboardScreen();
    QDeclarativeView* qmlView;

private:
    Ui::FridgeWhiteboardScreen *ui;
};

#endif // FRIDGEWHITEBOARDSCREEN_H
