...
#ifndef FRIDGEWEBBROWSER_H
#define FRIDGEWEBBROWSER_H

#include <QWidget>
#include <QDeclarativeView>

namespace Ui {
class FridgeWebBrowser;
}

extern bool isSmallResolution;

class FridgeWebBrowser : public QWidget
{
    Q_OBJECT
    
public:
    explicit FridgeWebBrowser(QWidget *parent = 0);
    ~FridgeWebBrowser();
    QDeclarativeView* qmlView;
    void setInitialURL();
    
private:
    Ui::FridgeWebBrowser *ui;
};

#endif // FRIDGEWEBBROWSER_H
