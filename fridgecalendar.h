...
#ifndef FRIDGECALENDAR_H
#define FRIDGECALENDAR_H

#include <QWidget>
#include <QDeclarativeView>

namespace Ui {
class FridgeCalendar;
}

extern bool isSmallResolution;

class FridgeCalendar : public QWidget
{
    Q_OBJECT
    
public:
    explicit FridgeCalendar(QWidget *parent = 0);
    ~FridgeCalendar();
    QDeclarativeView* qmlView;
    
private:
    Ui::FridgeCalendar *ui;
};

#endif // FRIDGECALENDAR_H
