...
#include "fridgezonesscreen.h"
#include "fridgewhiteboardscreen.h"
#include "fridgeepiscreen.h"
#include "fridgewebbrowser.h"
#include "fridgecalendar.h"
...
extern bool applicationActivity;
...
public:
    ...
    // MainWindow holds global instances for all screens
    OverlayControls* overlayControls;
    HomeScreen* homeScreen;
    FridgeWhiteboardScreen* fridgeWhiteboardScreen;
    FridgeZonesScreen* fridgeZonesScreen;
    FridgeEpiScreen* fridgeEpiScreen;
    FridgeWebBrowser* fridgeWebBrowserScreen;
    FridgeCalendar* fridgeCalendarScreen;
    FridgeContents* fridgeContentsScreen;
    
private slots:
    void switchToSettingsScreen();
    void switchToFridgeWhiteboardScreen();
    void switchToFridgeZonesScreen();
    void switchToFridgeEpiScreen();
    void switchToFridgeBrowserScreen();
    void switchToHomeScreen();
    void switchToFridgeCalendarScreen();
    void switchToFridgeContentsScreen();
