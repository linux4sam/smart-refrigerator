...
**
** Summary: C++ class that handles QML code for fridge calendar controls
**
****************************************************************************/


#include "fridgecalendar.h"
#include "ui_fridgecalendar.h"
 ...
 **/
FridgeCalendar::FridgeCalendar(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::FridgeCalendar)
{
    ui->setupUi(this);
    ...
    if (isSmallResolution) {
        ...
        qmlView->setSource(QUrl("qrc:/qml/SmallFridgeCalendar/main.qml"));
    } else {
        qmlView->setSource(QUrl("qrc:/qml/FridgeCalendar/main.qml"));
    }

    ui->calendarLayout->addWidget(qmlView);
}

/***
 ** Default destructor
 **/
FridgeCalendar::~FridgeCalendar()
{
    delete qmlView;
    delete ui;
}
